    ...
    <div id="projects" className="h-[100vh] w-full overflow-hidden">
      ...
      <div className="mx-6 my-28">
        <div
          ...
          className="xl:flex bg-white rounded-2xl border-black border-4 border-r-[12px] border-b-[12px] text-ellipsis cursor-pointer w-full hover:-translate-y-3 transition-all active:border-r-8 active:border-b-8 active:-translate-y-2 active:translate-x-1"
        >
          <Image
          ...
          <div className="my-4 mx-4 w-full max-w-2xl overflow-hidden">
            <h1 className="text-4xl font-bold truncate">Quotopia • A quote sharing social media</h1>
            <p className="text-2xl text-slate-600 w-full">
            ...
            <div className="flex gap-2 w-full h-8">
              <div className="text-2xl text-white bg-black px-4 rounded-md">Next.js</div>
              <div className="text-2xl text-white bg-sky-500 px-4 rounded-md">Tailwind</div>
            </div>
          </div>
        </div>
        <div
          ...
          className="xl:flex mt-6 bg-white rounded-2xl border-black border-4 border-r-[12px] border-b-[12px] text-ellipsis cursor-pointer w-full hover:-translate-y-3 transition-all active:border-r-8 active:border-b-8 active:-translate-y-2 active:translate-x-1"
        >
          <Image
            className="rounded-xl border-slate-400 border-2 m-3"
          ...
          />
          <div className="my-4 mx-4 w-full max-w-2xl overflow-hidden">
            <h1 className="text-4xl font-bold truncate">My Portfolio • It&apos;s me!</h1>
            <p className="text-2xl text-slate-600 w-full">
        ...
        >
          ...
          />
          <div className="my-4 mx-4 w-full max-w-2xl overflow-hidden">
            <h1 className="text-4xl font-bold truncate">Edi Translation • Tool for EDI files</h1>
            <p className="text-2xl text-slate-600 w-full">
            ...
            <div className="flex gap-2 w-full h-8">
              <div className="text-2xl text-white bg-cyan-600 px-4 rounded-md">React</div>
              <div className="text-2xl text-white bg-blue-700 px-4 rounded-md">Material UI</div>
            </div>
          </div>
        </div>
      </div>
