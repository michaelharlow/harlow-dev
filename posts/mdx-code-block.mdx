...
Now we can add custom styling to the code blocks as detailed in the rehype-prety-code [documentation](https://rehype-pretty.pages.dev/#styles). below are some examples of what I did with.
